...
# differential arm length between 100 Hz and 1000 Hz.
# Such physical couplings can mimic or mask a gravitational wave signal
# inferred from the differential arm length motion.
