...
latex_documents = [
  ('index', 'GWpy.tex', u'GWpy Documentation', u'Duncan Macleod', 'manual'),
]
...
man_pages = [
    ('index', 'ligo-gwpy', u'GWpy Documentation', [u'Duncan Macleod'], 1)
]
...
texinfo_documents = [
  ('index', 'GWpy', u'GWpy Documentation',
   u'Brian Moe, Chris Pankow, Duncan Macleod', 'GWpy', 'One line description of project.',
   'Miscellaneous'),
]
